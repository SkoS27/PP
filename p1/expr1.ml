...
(*- : float = 1.*)
(*1.0 * 2;;
Error: error de tipos debido al multiplicar un float y un int*)
(*2 -2.0;;
Error: error de tipos debido al restar un float a un int*)
(*3.0 + 2.0;;
Error: error de tipos debido a que la resta esperaba tipos int*)
5 / 3;;
(*- : int = 1*)
5 mod 3;;
(*- : int = 2*)
...
(*- : int = -1*)
(*z ;;
Error: unbound value, no existe el parametro z*)
let z = x + y ;;
(*val z : int = 3*)
z ;;
(*- : int = 3*)
...
(*l 2 ;;
Error, multiplicamos un int por un float*)
(*pi ;;
